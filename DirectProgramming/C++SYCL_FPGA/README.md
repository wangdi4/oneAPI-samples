...
| [component_interfaces_comparison](Tutorials/Features/ip_authoring_interfaces/component_interfaces_comparison)                 | [Tutorials/Features/ip_authoring_interfaces](Tutorials/Features/ip_authoring_interfaces) | This sample introduces different invocation/data interfaces that can be used when creating FPGA IP with the Intel® oneAPI DPC++/C++ Compiler
...
| [invocation_interfaces](Tutorials/Features/ip_authoring_interfaces/invocation_interfaces/)                                    | [Tutorials/Features/ip_authoring_interfaces](Tutorials/Features/ip_authoring_interfaces/)                                 | Demonstrates how to specify the kernel invocation interface and kernel argument interface for an FPGA IP produced with the Intel® oneAPI DPC++/C++ Compiler. 
...
| [mmhost](Tutorials/Features/ip_authoring_interfaces/mmhost)                                                                   | [Tutorials/Features/ip_authoring_interfaces](Tutorials/Features/ip_authoring_interfaces) | Basics of declaring Avalon memory-mapped host data interfaces for IP components
| [annotated_allocation](Tutorials/Features/ip_authoring_interfaces/annotated_allocation)                                                                   | [Tutorials/Features/ip_authoring_interfaces](Tutorials/Features/ip_authoring_interfaces) | Basics of declaring Avalon memory-mapped host data interfaces for IP components
...
| [invocation_interfaces](Tutorials/Features/ip_authoring_interfaces/invocation_interfaces)                                     | [Tutorials/Features/ip_authoring_interfaces](Tutorials/Features/ip_authoring_interfaces) | How to specify the kernel invocation interface and kernel argument interfaces
| [streaming_data_interfaces](Tutorials/Features/ip_authoring_interfaces/streaming_data_interfaces)                             | [Tutorials/Features/ip_authoring_interfaces](Tutorials/Features/ip_authoring_interfaces) | How to use pipes to implement streaming data interfaces on an IP component
